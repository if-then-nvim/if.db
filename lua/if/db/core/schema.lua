...
---@param url string
---@param callback fun(schemas: IfDb.Schema[], err: string|nil)
...
---@param url string
---@param schema_name string
---@param callback fun(tables: IfDb.Table[], err: string|nil)
...
---@param url string
---@param table_name string
---@param callback fun(columns: IfDb.Column[], err: string|nil)
